...
import com.google.samples.apps.nowinandroid.ui.homeworks.homework16.node.SearchToolBarNode
...
class SearchScreen(semanticsProvider: SemanticsNodeInteractionsProvider? = null) :
    ...
    val searchToolBarNode: SearchToolBarNode = child {
        hasTestTag(TestingTag.SEARCH_TOOLBAR)
    }
}